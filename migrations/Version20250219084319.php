 ...
 */
final class Version20250219084319 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_F02418C61ECFAAD2 ON input_url (url_pattern)');
        $this->addSql('CREATE TABLE route_step (id SERIAL NOT NULL, input_url_id INT NOT NULL, on_pass_step_id INT DEFAULT NULL, on_decline_step_id INT DEFAULT NULL, scheme_type VARCHAR(255) NOT NULL, scheme_props JSON NOT NULL, discr VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE route_step ADD CONSTRAINT FK_EEFCFFB94D7B53BA FOREIGN KEY (input_url_id) REFERENCES input_url (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
